...
class OMSData(models.Model):
    ...
    upload_date = models.DateField()  # "Дата выгрузки"
    ...
    visits = models.IntegerField()  # "Посещения"
    mo_visits = models.IntegerField()  # "Посещения в МО"
    home_visits = models.IntegerField()  # "Посещения на Дому"
    ...
    paid = models.DecimalField(max_digits=10, decimal_places=2)  # "Оплачено"
    ...
    uet = models.IntegerField(null=True, blank=True)  # "УЕТ"
