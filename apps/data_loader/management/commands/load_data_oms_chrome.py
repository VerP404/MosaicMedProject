...
from apps.data_loader.selenium.oms_chrome import selenium_oms_chrome
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        success, file_path = selenium_oms_chrome(username, password, start_date, end_date, start_date_treatment)
