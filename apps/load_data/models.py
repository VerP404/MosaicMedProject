...
class Talon(TimeStampedModel):
    ...
    additional_diagnosis = models.CharField(max_length=1500, null=True, blank=True, default='-')
...
class DetailedMedicalExamination(TimeStampedModel):
    ...
    additional_diagnosis = models.CharField(max_length=1500, default='-', verbose_name="Сопутствующий диагноз")
...
class JournalAppeals(models.Model):
    ...
    position = models.CharField("Должность", max_length=512, default='-')
    ...
    creator = models.CharField("Создавший", max_length=255, default='-')
    no_show = models.CharField("Не явился", max_length=128, default='-')
