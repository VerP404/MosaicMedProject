...
_REF_DT_STYLE = {"overflowX": "auto", "maxHeight": "480px"}
_REF_DT_EXPORT = {
    "export_format": "xlsx",
    "export_headers": "display",
    # fixed_rows не используем: в ряде версий Dash + hidden_columns даёт ошибки в layout (getWeight).
}
