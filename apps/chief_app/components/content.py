...
from apps.chief_app.components.cards.dd_rep import dd_table
    ...
    [
        dbc.Row(
            [
                ...
                dbc.Col(create_card("Диспансеризация", dd_table, "card2"), width=6),
            ]
        ),
        dbc.Row(
            [
                dbc.Col(create_card("Карточка 3", "Контент карточки 3", "card3"), width=4),
                dbc.Col(create_card("Диспансерное наблюдение", "Контент карточки 4", "card4"), width=4),
