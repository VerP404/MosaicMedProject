...
from services.MosaicMed.pages.doctors_talon.doctor.query import sql_query_stac_date_treatment_def, sql_query_amb_date_treatment_def, \
    sql_query_dd_date_treatment_def

type_page = "tab3-doctor-talon"

tab3_doctor_talon_layout = html.Div(
    [
        dbc.Row(
            dbc.Col(
                dbc.Card(
...
def update_table_dd(value_doctor, start_date, end_date):
    ...
    columns1, data1 = TableUpdater.query_to_df(engine, sql_query_amb_date_treatment_def(), bind_params)
    columns2, data2 = TableUpdater.query_to_df(engine, sql_query_dd_date_treatment_def(), bind_params)
    columns3, data3 = TableUpdater.query_to_df(engine, sql_query_stac_date_treatment_def(), bind_params)
