...
from apps.MosaicMed.callback.callback import TableUpdater, get_current_reporting_month, get_selected_dates
...
from apps.MosaicMed.generate_pages.filters import filter_years, filter_months, filter_status, date_start, date_end
from apps.MosaicMed.pages.doctors_talon.doctor.query import sql_query_amb_date_form_def
from apps.MosaicMed.pages.doctors_talon.doctors_list.query import sql_query_by_doc, sql_query_by_doc_end_treatment
