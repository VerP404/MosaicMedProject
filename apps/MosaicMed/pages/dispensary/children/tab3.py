...
tab3_layout_other_children_age_dispensary = html.Div(
    [
        ...
        card_table(f'result-table1-{type_page}', "Отчет по профосмотрам несовершеннолетних с разбивкой по возрастам"),
    ],
    style={"padding": "0rem"}
)
...
def update_table_dd(start_date, end_date):
    ...
    columns1, data1 = TableUpdater.query_to_df(engine, sql_query_children_age_dispensary(), bind_params)
