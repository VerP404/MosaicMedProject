...
from apps.MosaicMed.pages.economic_reports.by_doctors_dispensary.query import (
    sql_query_by_doctor_dispensary_adult_f1,
    sql_query_by_doctor_dispensary_adult_f2,
    sql_query_by_doctor_dispensary_adult_f3
)
...
def update_table(n_clicks, selected_period, selected_status):
    ...
    columns1, data1 = TableUpdater.query_to_df(engine, sql_query_by_doctor_dispensary_adult_f1(sql_cond), bind_params)
    columns2, data2 = TableUpdater.query_to_df(engine, sql_query_by_doctor_dispensary_adult_f2(sql_cond), bind_params)
    columns3, data3 = TableUpdater.query_to_df(engine, sql_query_by_doctor_dispensary_adult_f3(sql_cond), bind_params)
