...
from apps.MosaicMed.pages.economic_reports.stationary.query import sql_query_stationary
...
def update_table(n_clicks, selected_period, selected_status, selected_cel):
    if n_clicks is None or not selected_period or not selected_status or not selected_cel:
    ...
    sql_query = sql_query_stationary(sql_cond)
