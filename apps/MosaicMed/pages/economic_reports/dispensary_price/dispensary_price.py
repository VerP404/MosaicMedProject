...
from apps.MosaicMed.pages.economic_reports.dispensary_price.query import sql_query_disp_dv4
...
def update_table(n_clicks, selected_period, selected_status, selected_type_dv):
    ...
    sql_query = sql_query_disp_dv4(sql_cond)
