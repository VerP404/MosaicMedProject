...
from apps.MosaicMed.pages.economic_reports.by_doctors_cel.query import sql_query_by_doctors_mest, \
    sql_query_by_doctors_inog
...
tab1_layout_by_doctor_cel_inog = html.Div(
    [
        ...
        card_table(f'result-table-{type_page}', "Иногородние", 15)
    ],
    style={"padding": "0rem"}
)
...
def update_table(n_clicks, selected_period, selected_status):
    ...
    sql_query = sql_query_by_doctors_inog(sql_cond)
