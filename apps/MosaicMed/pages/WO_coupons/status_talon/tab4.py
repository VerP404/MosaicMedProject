...
from apps.MosaicMed.callback.callback import TableUpdater, get_selected_dates, get_selected_specialist
from apps.MosaicMed.pages.WO_coupons.status_talon.query import sql_query_status_spec_korp

type_page = "status-spec-korp"

tab4_layout_other_status = html.Div(
    [
