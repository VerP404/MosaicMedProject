...
tab5_layout_other_status = html.Div(
    [
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.Label('По дате окончания лечения в талоне в Web OMS'),
                        html.Div([
        ...
        html.Hr(),
        html.H3('Отчет по талонам - дата окончания лечения и корпуса', className='label'),
...
def update_table_dd(start_date, end_date):
    ...
    columns, data = TableUpdater.query_to_df(engine, sql_query_status_korpus_date_fin, bind_params)
