...
from apps.MosaicMed.callback.callback import get_current_reporting_month
from apps.MosaicMed.generate_pages.constants import current_year, months_labels, status_groups
