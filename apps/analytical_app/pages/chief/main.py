...
chief_main = html.Div([
    dbc.Breadcrumb(id=f"breadcrumb-{type_page}", items=[
        {"label": "Главный врач", "href": "/chief", "active": True},
    ]),
    html.Hr(),
...
def navigate_pages(open_report_1, open_report_2, open_report_3, open_report_4):
    ...
    breadcrumb_items = [{"label": "Главный врач", "href": "/chief"}]

    if button_id.startswith("open-report-") and "chief" in button_id:
        if button_id == f'open-report-1-{type_page}' and open_report_1:
            ...
            return '/chief/disp_by_ages', breadcrumb_items
            ...
            return '/chief/dn_job', breadcrumb_items

    return '/chief', breadcrumb_items
