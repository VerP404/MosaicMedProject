...
from apps.analytical_app.components.filters import filter_status, status_groups, filter_years, \
    filter_report_type, filter_inogorod, filter_sanction, filter_amount_null, update_buttons, \
    get_current_reporting_month, date_picker, filter_months, get_available_buildings, get_available_departments, \
    filter_building, filter_department
...
def update_table(n_clicks, selected_period, selected_year, inogorodniy, sanction,
                 ...
                 selected_type_dv,
                 status_mode, selected_status_group,
