...
from apps.analytical_app.components.filters import filter_years, filter_months, get_current_reporting_month
from apps.analytical_app.elements import card_table, get_selected_period
from apps.analytical_app.pages.head.dispensary.adults.query import sql_query_do_korpus_dd
