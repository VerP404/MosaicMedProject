    ...
    [
        ...
        dbc.Col(
            create_card(13, type_page,
                        "Прикрепленные: прошли / не прошли",
                        "Прикрепленные из ИСЗЛ с фильтром по статусу диспансеризации и аналитикой по возрастам"),
            className="d-flex"
        ),
        dbc.Col(
        ...
        dbc.Col(
            create_card(15, type_page,
                        "Проверка карт",
                        "Проверка правильности порядка оформления карт"),
            className="d-flex"
        ),
        dbc.Col(
            create_card(16, type_page,
                        "Записаны на процедуру",
                        "Записи на процедуру из журнала: факт услуги и цели диспансеризации из ОМС"),
            className="d-flex"
        ),
    ],
    className="row-cols-1 row-cols-md-4 g-4 mb-4 align-items-stretch"
