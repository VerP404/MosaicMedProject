...
from apps.analytical_app.pages.head.dispensary.adults.tab16 import adults_dv16
...
from apps.analytical_app.pages.head.dispensary.children.tab5 import children_pn5
...
routes_head = {
    ...
    "/head/adults/dv12": html.Div([
        dbc.Breadcrumb(items=[
            {"label": "Заведующий", "href": "/head"},
            {"label": "Диспансеризация взрослых", "href": "/head/adults"},
            {"label": "Записаны, но не прошли", "active": True},
        ]),
        adults_dv12
    ]),
    "/head/adults/dv13": html.Div([
        dbc.Breadcrumb(items=[
            {"label": "Заведующий", "href": "/head"},
            {"label": "Диспансеризация взрослых", "href": "/head/adults"},
            {"label": "Прикрепленные не прошедшие", "active": True},
        ]),
        adults_dv13
    ]),
    "/head/adults/dv14": html.Div([
        dbc.Breadcrumb(items=[
            {"label": "Заведующий", "href": "/head"},
            {"label": "Диспансеризация взрослых", "href": "/head/adults"},
    ...
    "/head/adults/dv16": html.Div([
        dbc.Breadcrumb(items=[
            {"label": "Заведующий", "href": "/head"},
            {"label": "Диспансеризация взрослых", "href": "/head/adults"},
            {"label": "Записаны на процедуру", "active": True},
        ]),
        adults_dv16
    ]),
    ...
    "/head/children/pn5": html.Div([
        dbc.Breadcrumb(items=[
            {"label": "Заведующий", "href": "/head"},
            {"label": "Диспансеризация детей", "href": "/head/children"},
            {"label": "Записаны, но нет ПН1", "active": True},
        ]),
        children_pn5
    ]),
