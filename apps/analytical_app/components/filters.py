...
status_groups = {
    'Оплаченные (3)': ['3'],
    'Готовые к сборке (1,4,6,8,19)': ['1', '4', '6', '8', '19'],
    'Превышение объемов (4)': ['4'],
    'Предъявленные и оплаченные (2,3)': ['2', '3'],
    'Предъявленные первичные (1,2,3)': ['1', '2', '3'],
    'Предъявленные первичные и повторные (1,2,3,4,6,8,19)': ['1', '2', '3', '4', '6', '8', '19'],
    'Отказы (5,7,12,18)': ['5', '7', '12', '18'],
    'Отменено (0,13,17)': ['0', '13', '17'],
    'Все статусы': ['0', '1', '2', '3', '4', '5', '6', '7', '8', '12', '13', '17', '18', '19']
}
months_dict = {
...
status_descriptions = {
    ...
    '13': 'Удален МИС',
    '17': 'Отмен МИС',
    '18': 'Дефект санкций ТФОМС',
    '19': 'Исправлен дефект санкций'
}
