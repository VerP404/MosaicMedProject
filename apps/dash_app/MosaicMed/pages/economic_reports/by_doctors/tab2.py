...
from services.MosaicMed.pages.economic_reports.by_doctors.query import sql_query_by_doctors, \
    sql_query_by_doctors_stac_rep
...
tab2_layout_by_doctor = html.Div(
    [
        ...
        card_table(f'result-table-{type_page}', "Отчет по врачам по стационарам", 8)
    ],
    style={"padding": "0rem"}
)
...
def update_table(n_clicks, selected_period, selected_status):
    ...
    sql_query = sql_query_by_doctors_stac_rep(sql_cond)
