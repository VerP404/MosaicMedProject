...
from services.MosaicMed.pages.dispensary.adults.query import query_age_dispensary
...
tab5_layout_da = html.Div(
    [
        ...
        card_table(f'result-table-{type_page}', "Отчет по профосмотрам ОПВ с разбивкой по возрастам")
    ],
    style={"padding": "0rem"}
)
