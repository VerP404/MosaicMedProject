...
def get_sidebar():
    nav_items = [
        dbc.NavLink(
            [
                ...
                html.Span(" Главная", className="nav-text", title="Главная")
            ],
        ...
        dbc.NavLink(
            [
                ...
                html.Span(" ЭЛН", className="nav-text", title="ЭЛН")
            ],
    ...
    return html.Div(
        [
            html.H2(className="display-8 text-center", id="sidebar-title"),
